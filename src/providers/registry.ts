...
export const PROVIDER_REGISTRY: readonly ProviderRegistryEntry[] = [
  ...
  },
  {
    ...
    defaultModel: "glm-5.2",
    dashboardUrl: "http://127.0.0.1:8080/webui",
    note: "Local ZCode reverse proxy — Z.AI/Bigmodel coding plan",
    models: ["glm-5.2", "glm-5.1", "glm-5", "glm-4.7", "glm-4.6", "glm-4.6v", "glm-5-turbo", "glm-5v-turbo", "glm-4.5-air"],
    modelContextWindows: { "glm-5.2": 1_000_000 },
    modelSuffixBracketStrip: true,
    liveModels: false,
  },
